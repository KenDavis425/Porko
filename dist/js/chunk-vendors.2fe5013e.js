 ...
 * limitations under the License.
 */
function Ou(e){e=de(e,pc);const t=de(e.firestore,Tc);return rc(Ic(t),e._key).then(n=>ju(t,e,n))}Ru._jsonSchemaVersion="firestore/querySnapshot/1.0",Ru._jsonSchema={type:pe("string",Ru._jsonSchemaVersion),bundleSource:pe("string","QuerySnapshot"),bundleName:pe("string"),bundle:pe("string")};class Du extends Eu{constructor(e){super(),this.firestore=e}convertBytes(e){return new kc(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new pc(this.firestore,null,t)}}function Pu(e){e=de(e,fc);const t=de(e.firestore,Tc),n=Ic(t),r=new Du(t);return ou(e._query),sc(n,e._query).then(n=>new Ru(t,r,e,n))}function xu(e,t,n){e=de(e,pc);const r=de(e.firestore,Tc),s=Iu(e.converter,t,n);return Fu(r,[$c(jc(r),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,Dr.none())])}function Lu(e,t,n,...r){e=de(e,pc);const s=de(e.firestore,Tc),i=jc(s);let o;return o="string"==typeof(t=(0,c.Ku)(t))||t instanceof Rc?Kc(i,"updateDoc",e._key,t,n,r):Hc(i,"updateDoc",e._key,t),Fu(s,[o.toMutation(e._key,Dr.exists(!0))])}function Mu(e){return Fu(de(e.firestore,Tc),[new Hr(e._key,Dr.none())])}function Uu(e,t){const n=de(e.firestore,Tc),r=yc(e),s=Iu(e.converter,t);return Fu(n,[$c(jc(e.firestore),"addDoc",r._key,s,null!==e.converter,{}).toMutation(r._key,Dr.exists(!1))]).then(()=>r)}function Vu(e,...t){e=(0,c.Ku)(e);let n={includeMetadataChanges:!1,source:"default"},r=0;"object"!=typeof t[r]||bc(t[r])||(n=t[r++]);const s={includeMetadataChanges:n.includeMetadataChanges,source:n.source};if(bc(t[r])){const e=t[r];t[r]=e.next?.bind(e),t[r+1]=e.error?.bind(e),t[r+2]=e.complete?.bind(e)}let i,o,a;if(e instanceof pc)o=de(e.firestore,Tc),a=Vn(e._key.path),i={next:n=>{t[r]&&t[r](ju(o,e,n))},error:t[r+1],complete:t[r+2]};else{const n=de(e,fc);o=de(n.firestore,Tc),a=n._query;const s=new Du(o);i={next:e=>{t[r]&&t[r](new Ru(o,s,n,e))},error:t[r+1],complete:t[r+2]},ou(e._query)}return function(e,t,n,r){const s=new Ga(r),i=new da(t,s,n);return e.asyncQueue.enqueueAndForget(async()=>ia(await nc(e),i)),()=>{s.Nu(),e.asyncQueue.enqueueAndForget(async()=>oa(await nc(e),i))}}(Ic(o),a,s,i)}function Fu(e,t){return function(e,t){const n=new U;return e.asyncQueue.enqueueAndForget(async()=>Ca(await ec(e),t,n)),n.promise}(Ic(e),t)}function ju(e,t,n){const r=n.docs.get(t._key),s=new Du(e);return new Au(e,s,t._key,r,new Cu(n.hasPendingWrites,n.fromCache),t.converter)}function $u(e){return Bu(e,{count:Su()})}function Bu(e,t){const n=de(e.firestore,Tc),r=Ic(n),s=dt(t,(e,t)=>new Xr(t,e.aggregateType,e._internalFieldPath));return ic(r,e._query,s).then(t=>function(e,t,n){const r=new Du(e),s=new Ac(t,r,n);return s}
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * limitations under the License.
 */
class qu{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=jc(e)}set(e,t,n){this._verifyNotCommitted();const r=zu(e,this._firestore),s=Iu(r.converter,t,n),i=$c(this._dataReader,"WriteBatch.set",r._key,s,null!==r.converter,n);return this._mutations.push(i.toMutation(r._key,Dr.none())),this}update(e,t,n,...r){this._verifyNotCommitted();const s=zu(e,this._firestore);let i;return i="string"==typeof(t=(0,c.Ku)(t))||t instanceof Rc?Kc(this._dataReader,"WriteBatch.update",s._key,t,n,r):Hc(this._dataReader,"WriteBatch.update",s._key,t),this._mutations.push(i.toMutation(s._key,Dr.exists(!0))),this}delete(e){this._verifyNotCommitted();const t=zu(e,this._firestore);return this._mutations=this._mutations.concat(new Hr(t._key,Dr.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new M(L.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function zu(e,t){if((e=(0,c.Ku)(e)).firestore!==t)throw new M(L.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hu(){return new qc("serverTimestamp")}function Ku(e){return new zc("increment",e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Gu(e){return Ic(e=de(e,Tc)),new qu(e,t=>Fu(e,t))
/**
 * @license
 * Copyright 2021 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.2fe5013e.js.map